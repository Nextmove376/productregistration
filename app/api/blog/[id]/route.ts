...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  await pool.execute(
    ...
    [d.title, d.slug, d.excerpt ?? "", d.content, d.featured_image ?? null, d.image_alt ?? "", d.category_id ?? null, d.author ?? "", d.status, d.published_at ?? null, d.meta_title ?? "", d.meta_description ?? "", d.og_image ?? null, d.reading_minutes ?? 0, id]
  );
