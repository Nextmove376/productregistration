...
export const metadata: Metadata = {
  title: 'About Us | Next Move Services — UAE Product Registration Experts',
  description: 'Learn about Next Move Services, a Dubai-based regulatory consultancy specialising in product registration, MOHAP approvals, and business setup in UAE.',
  alternates: { canonical: 'https://productregistrationinuae.com/about' },
  openGraph: {
    title: 'About Us | Next Move Services',
    description: 'Dubai-based regulatory consultancy specialising in product registration, MOHAP approvals, and business setup in UAE.',
    url: 'https://productregistrationinuae.com/about',
