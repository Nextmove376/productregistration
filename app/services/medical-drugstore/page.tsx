...
export const metadata: Metadata = {
  title: 'Trademark & Drugstore Setup | UAE Pharmacy License',
  description: 'UAE trademark registration and turnkey medical drugstore setup with full compliance stack. Expert pharmacy fit-out and ministry inspections.',
  alternates: { canonical: 'https://productregistrationinuae.com/services/medical-drugstore' },
  openGraph: {
    title: 'Trademark & Drugstore Setup | Next Move Services',
    description: 'UAE trademark registration and turnkey medical drugstore setup.',
    url: 'https://productregistrationinuae.com/services/medical-drugstore',
    images: [{ url: '/images/svc-trademark.jpg', width: 800, height: 600 }],
  },
};
