...
export const metadata: Metadata = {
  title: 'Product Registration in Dubai | Dubai Municipality & ESMA',
  description: 'Register cosmetics, food, supplements and household goods through Dubai Municipality, ESMA and MOIAT. 3–8 week typical turnaround.',
  alternates: { canonical: 'https://productregistrationinuae.com/services/product-registration' },
  openGraph: {
    title: 'Product Registration in Dubai | Next Move Services',
    description: 'Register cosmetics, food, supplements through Dubai Municipality, ESMA and MOIAT.',
    url: 'https://productregistrationinuae.com/services/product-registration',
    images: [{ url: '/images/svc-product.jpg', width: 800, height: 600 }],
  },
};
