...
export const metadata: Metadata = {
  title: 'Regulatory Approvals | Free-Sale, GMP, Halal Certification UAE',
  description: 'Free-sale certificates, GMP verification, lab testing, Halal certification and ISO alignment for UAE product registration. 2–6 week timeline.',
  alternates: { canonical: 'https://productregistrationinuae.com/services/regulatory-approvals' },
  openGraph: {
    title: 'Regulatory Approvals | Next Move Services',
    description: 'Free-sale certificates, GMP verification, Halal certification for UAE product registration.',
    url: 'https://productregistrationinuae.com/services/regulatory-approvals',
    images: [{ url: '/images/svc-approvals.jpg', width: 800, height: 600 }],
  },
};
