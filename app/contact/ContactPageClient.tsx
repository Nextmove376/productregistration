...
import { MapPin, Phone, Mail, Clock, ArrowUpRight, Send, CheckCircle2, Loader2 } from 'lucide-react';
            ...
            <div className="group rounded-3xl border border-border bg-[var(--cream)] p-7 transition-all hover:border-[var(--teal)]/40 hover:shadow-lg">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@nextmoveservices.ae" className="mt-1 block text-sm text-[var(--teal-deep)] hover:underline">hello@nextmoveservices.ae</a>
                </div>
              </div>
            </div>
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    <div>
                      <label htmlFor="contact-name" className="mb-2 block text-xs uppercase tracking-wider text-muted-foreground">Your name</label>
                      <input id="contact-name" name="name" required placeholder="John Doe" className="w-full rounded-xl border border-border bg-white px-4 py-3.5 text-sm outline-none transition-colors focus:border-[var(--teal)]" />
                    </div>
                    <div>
                      <label htmlFor="contact-email" className="mb-2 block text-xs uppercase tracking-wider text-muted-foreground">Email address</label>
                      <input id="contact-email" name="email" type="email" required placeholder="john@example.com" className="w-full rounded-xl border border-border bg-white px-4 py-3.5 text-sm outline-none transition-colors focus:border-[var(--teal)]" />
                    </div>
                  </div>
                  <div className="grid gap-5 md:grid-cols-2">
                    <div>
                      <label htmlFor="contact-phone" className="mb-2 block text-xs uppercase tracking-wider text-muted-foreground">Phone number</label>
                      <input id="contact-phone" name="phone" type="tel" placeholder="+971 50 123 4567" className="w-full rounded-xl border border-border bg-white px-4 py-3.5 text-sm outline-none transition-colors focus:border-[var(--teal)]" />
                    </div>
                    <div>
                      <label htmlFor="contact-company" className="mb-2 block text-xs uppercase tracking-wider text-muted-foreground">Company name</label>
                      <input id="contact-company" name="company" placeholder="Your company LLC" className="w-full rounded-xl border border-border bg-white px-4 py-3.5 text-sm outline-none transition-colors focus:border-[var(--teal)]" />
                    </div>
                  </div>
                  <div>
                    <label htmlFor="contact-service" className="mb-2 block text-xs uppercase tracking-wider text-muted-foreground">Service needed</label>
                    <select id="contact-service" name="service" className="w-full rounded-xl border border-border bg-white px-4 py-3.5 text-sm outline-none transition-colors focus:border-[var(--teal)]">
                      <option value="">Choose a service…</option>
                      <option value="mohap-registration">MOHAP / EDE Registration</option>
                      ...
                      <option value="mofa-attestation">MOFA & PRO Services</option>
                      <option value="business-setup">Business Setup</option>
                      <option value="medical-drugstore">Trademark & Drugstore</option>
                    </select>
                  </div>
                  <div>
                    <label htmlFor="contact-message" className="mb-2 block text-xs uppercase tracking-wider text-muted-foreground">Your message</label>
                    <textarea id="contact-message" name="message" rows={4} required placeholder="Tell us briefly about your project…" className="w-full rounded-xl border border-border bg-white px-4 py-3.5 text-sm outline-none transition-colors focus:border-[var(--teal)]" />
                  </div>
                  <button type="submit" disabled={sending} className="flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--navy)] py-4 text-sm font-medium text-[var(--cream)] transition-all hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0">
      ...
      <section className="border-y border-border bg-[var(--cream)]">
        <div className="mx-auto grid max-w-7xl gap-0 px-0 md:grid-cols-2">
          ...
          <div className="min-h-[380px] bg-[var(--sand)] flex items-center justify-center">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.5!2d55.3!3d25.2!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDEyJzAwLjAiTiA1NcKwMTgnMDAuMCJF!5e0!3m2!1sen!2sae!4v1"
              width="100%"
              height="100%"
              ...
              title="NextMove Services office location in Dubai"
            />
          </div>
        </div>
      </section>
