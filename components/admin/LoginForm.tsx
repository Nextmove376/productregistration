...
export default function LoginForm({ next }: { next: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // `replace` keeps the login page out of a signed-in user's back-history.
      router.replace(next);
      router.refresh();
    } catch (err) {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 py-3 pl-10 pr-4 text-sm outline-none transition-colors focus:border-gray-400 focus:ring-2 focus:ring-gray-900/10"
