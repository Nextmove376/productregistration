...
const SERVICES = [
  ...
  { num: '02', title: 'Product Registration', desc: 'Cosmetics, food, supplements — Dubai Municipality & ESMA.', href: '/services/product-registration' },
  ...
  { num: '05', title: 'Business Setup', desc: 'Mainland, Freezone — SHAMS, Meydan, SPC formation.', href: '/services/business-setup' },
    ...
    <section id="services" className="border-y border-border bg-[var(--cream)] py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 flex flex-wrap items-end justify-between gap-6">
          ...
          <Link href="/services" className="text-sm underline underline-offset-4">Learn more →</Link>
        </div>
          ...
          {SERVICES.map((s) => (
            <Link key={s.num} href={s.href} className="group relative flex flex-col justify-between bg-[var(--cream)] p-8 transition-colors hover:bg-background">
              <div className="flex items-start justify-between">
                ...
                <span className="text-lg text-muted-foreground transition-transform group-hover:-translate-y-1 group-hover:translate-x-1">↗</span>
              </div>
              <div className="mt-24">
