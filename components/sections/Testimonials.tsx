const REVIEWS = [
  { q: 'Registering our diagnostic equipment with the Department of Health – Abu Dhabi was a critical milestone. Every step handled with accuracy and efficiency.', a: 'Meditech Supplies LLC', when: '1 month ago' },
  ...
  { q: 'Complex imported food registration handled smoothly. Deep knowledge of Dubai Municipality and ESMA procedures — a truly reliable partner.', a: "Al Ru'ya Al Tibbiyya Sweets", when: '2 months ago' },
];
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {REVIEWS.map((r, i) => (
          <figure key={i} className="flex flex-col justify-between rounded-3xl border border-border/70 bg-card p-7 shadow-[var(--shadow-soft)]">
            <div className="mb-5 flex text-primary">{'★★★★★'}</div>
